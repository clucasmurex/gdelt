...
def parse_args():
    ...
    p.add_argument("--output_dir",   type=Path, default=Path("./data/indicators_france_corporate"))
    ...
    p.add_argument("--retained_ids", type=Path, default=Path("media_pool_corporate.txt"))
